...
public:
    ...
    virtual void Doequipment_snotMatch(const Ch* str, SizeType length) = 0;
...
public:
    ...
    bool String(Context& context, const Ch* str, SizeType length, bool) const {
        ...
        if (pattern_ && !IsPatternMatch(pattern_, str, length)) {
            context.error_handler.Doequipment_snotMatch(str, length);
...
public:
    ...
    */
    ...
    void Doequipment_snotMatch(const Ch* str, SizeType length) {
